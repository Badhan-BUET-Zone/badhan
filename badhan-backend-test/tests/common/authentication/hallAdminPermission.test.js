...
test('hall admin permission test', async () => {
    ...
    await operations.expectErrorWithToken('patch', '/donors/designation', volunteerTokenResponse.data.token, hallAdminPermissionErrorSchema, { donorId: me.data.donor._id, promoteFlag: true });
