const { createDonor, signInSuperAdmin, promoteToVolunteer, promoteToSuperAdmin } = require("../../lib/operations");
...
test("PATCH/admins: success", async () => {
    ...
    let superAdminPromotionResult = await promoteToSuperAdmin(
      sampleVolunteerID,
      signInResponse
    );
});
