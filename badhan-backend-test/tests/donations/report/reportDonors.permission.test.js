...
test('GET/donations/report/donors: requires super admin (volunteer and hall admin forbidden)', async () => {
  ...
  const path = `/donations/report/donors?startDate=${startDate}&endDate=${endDate}&bloodGroup=-1&hall=-1`;
