...
test('GET/platelet-donations/report: hallwiseReport breaks the total down per hall', async () => {
  ...
  const donorAResponse = await operations.createDonor({
    ...
    fatherName: 'Hallwise Platelet Donor A Father',
    motherName: 'Hallwise Platelet Donor A Mother',
    studentId: 1900301,
  ...
  const donorBResponse = await operations.createDonor({
    ...
    fatherName: 'Hallwise Platelet Donor B Father',
    motherName: 'Hallwise Platelet Donor B Mother',
    studentId: 1900302,
    address: 'Test Address',
    roomNumber: '3002',
    comment: 'hallwise platelet test',
