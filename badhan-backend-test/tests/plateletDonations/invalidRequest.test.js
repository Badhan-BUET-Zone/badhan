...
test("GET/platelet-donations/report: invalid request", async () => {
  ...
  // invalid start date
  await expectGuestError('get', '/platelet-donations/report?startDate=2&endDate=1717113600000', invalidRequestSchema);

  // invalid end date
  await expectGuestError('get', '/platelet-donations/report?startDate=1707237110000&endDate=2', invalidRequestSchema);
});
