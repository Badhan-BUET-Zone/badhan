...
// Documentation screenshot for docs/blog/new-feature-new-student-data-collection.md — question 8
...
describe('docs screenshot — registration question 8 (plateletDonationCount)', () => {
  it('captures the plateletDonationCount step on its own', () => {
    ...
    hideOverlays();
    cy.wait(1500);
    cy.get('[data-cy="registrationStep-plateletDonationCount"]').screenshot('registration-q08-plateletDonationCount');
  });
});
