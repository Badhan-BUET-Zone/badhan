...
// Documentation screenshot for docs/blog/new-feature-new-student-data-collection.md — question 10
...
describe('docs screenshot — registration question 10 (roomNumber)', () => {
  it('captures the roomNumber step on its own', () => {
    ...
    hideOverlays();
    cy.wait(1500);
    cy.get('[data-cy="registrationStep-roomNumber"]').screenshot('registration-q10-roomNumber');
  });
});
