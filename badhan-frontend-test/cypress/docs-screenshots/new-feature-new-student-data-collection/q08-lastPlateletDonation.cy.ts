...
describe('docs screenshot — registration question 8 (lastPlateletDonation)', () => {
  it('captures the lastPlateletDonation step on its own', () => {
    ...
    hideOverlays();
    cy.wait(1500);
    cy.get('[data-cy="registrationStep-lastPlateletDonation"]').screenshot('registration-q08-lastPlateletDonation');
  });
});
