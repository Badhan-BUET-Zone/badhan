...
describe('docs screenshot — registration question 11 (availableToAll)', () => {
  it('captures the availableToAll step on its own', () => {
    ...
    hideOverlays();
    cy.wait(1500);
    cy.get('[data-cy="registrationStep-availableToAll"]').screenshot('registration-q11-availableToAll');
  });
});
