...
**Every donor record carries a role.** The app will not save a donor without one, and records old
enough to have been created before that rule existed have been repaired to Donor — which is what the
app had been showing for them all along ([chapter 4](04-roles-and-permissions.md)).
